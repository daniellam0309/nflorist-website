...
const albumSpecs = [
  ...
  ["mothersday2026", () => range((file) => up("love520", file), "love520", 1, 13)],
];
...
export function validateWebsiteData() {
  ...
  if (holidayAlbum?.images.length !== 13) errors.push("520 album must contain 13 images.");
  ...
  if (!T.zh.holiday || !T.en.holiday) errors.push("Missing holiday nav label.");
